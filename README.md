...
[![GitHub Actions CI Status](https://github.com/nf-core/phageannotator/workflows/nf-core%20CI/badge.svg)](https://github.com/nf-core/phageannotator/actions?query=workflow%3A%22nf-core+CI%22)
[![GitHub Actions Linting Status](https://github.com/nf-core/phageannotator/workflows/nf-core%20linting/badge.svg)](https://github.com/nf-core/phageannotator/actions?query=workflow%3A%22nf-core+linting%22)[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/phageannotator/results)[![Cite with Zenodo](http://img.shields.io/badge/DOI-10.5281/zenodo.XXXXXXX-1073c8?labelColor=000000)](https://doi.org/10.5281/zenodo.XXXXXXX)
...
To see the results of an example test run with a full size dataset refer to the [results](https://nf-co.re/phageannotator/results) tab on the nf-core website pipeline page.
For more details about the output files and reports, please refer to the
[output documentation](https://nf-co.re/phageannotator/output).
