...
# Code taken from https://bitbucket.org/berkeleylab/checkv/src/master/scripts/aniclust.py
...
def parse_arguments():
    ...
    parser.add_argument("--fna", type=str, required=True, metavar="PATH", help="""Path to nucleotide sequences""")
    parser.add_argument(
        "--ani",
        type=str,
        required=True,
    ...
    parser.add_argument("--out", type=str, required=True, metavar="BASENAME", help="""Path to output file""")
    parser.add_argument(
        "--exclude", type=str, metavar="PATH", help="""Path to list of sequence ids to exclude from clustering"""
    )
    parser.add_argument(
        "--keep", type=str, metavar="PATH", help="""Path to list of sequence ids to keep from clustering"""
    )
    parser.add_argument(
        "--min_ani",
        type=float,
    ...
    parser.add_argument(
        "--min_length", type=float, metavar="INT", default=1, help="""Minimum sequence length (default=1)"""
    )
